...
def setup():
    print("Applying PDF Fixes & Base64 Logo...")
    try:
        update_print_format_base64()
        frappe.db.commit()
        print("Print Format Updated Successfully with Base64 Logo!")
...
def update_print_format_base64():
    ...
    if os.path.exists(logo_path):
        ...
        img_src = "" # Or a placeholder

    branding_color = "#003366"

    # 2. Update HTML with Base64 Image
    html = f"""
    <div style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #333; font-size: 13px;">
        ...
        <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
            <tr>
                <!-- Logo Left: Base64 Embed for PDF Reliability -->
                <td style="width: 50%; vertical-align: top;">
                    <img src="{img_src}" style="max-height: 80px; max-width: 200px;">
                </td>
                <!-- Company Info Right -->
